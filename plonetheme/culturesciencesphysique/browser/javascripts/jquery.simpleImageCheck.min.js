...
var l=$('label[for="'+id+'"]');var im=n.before("<img src='http://"+document.location.hostname+"/"+src+"' id='ic_"+id+"' alt='"+l.text()+"' title='"+l.text()+"' class='imageCheck"+((c)?' checked':'')+"' role='checkbox' aria-checked='"+((c)?'true':'false')+"' aria-controls='"+id+"' />").parent().find('img#ic_'+id);n.click(function(e,triggered){if(triggered===true){return;}
